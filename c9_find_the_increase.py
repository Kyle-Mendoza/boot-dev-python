...
def check_character_levels():
    ...
    for i in range(0, len(old_character_levels)):  
        does_level_up = new_character_levels[i] > old_character_levels[i] # if the character level up we want to save that index

        if does_level_up:
            print(i)       # print the index that levels up 
